...
# =========================================================
# ⚙️ AUTOMATIC ERROR ABSORPTION FILTER (FALLBACK SIMULATOR)
# =========================================================
if demo_mode or engine_status != "SUCCESS":
...
lineage_integrity = "100% Authentic API" if not is_simulated_active else "100% Emulated"
